...
IF NOT EXIST "%~dp0\optel_codebase" CALL git clone git@github.com:optelgroup/optel_codebase.git
...
REM Build All + Test
CALL fastbuild -summary -ide All+Test-x86-Debug All+Test-x86-DebugUnicode > "%~dp0\%fullstamp%\build_log.txt"

REM Test Run
CALL fastbuild -summary -ide All+TestRun-x86-Debug > "%~dp0\%fullstamp%\testDebug_log.txt"
CALL fastbuild -summary -ide All+TestRun-x86-DebugUnicode > "%~dp0\%fullstamp%\testDebugUnicode_log.txt"
...
FINDSTR /C:"FBuild: OK: All+Test-x86-Debug" "%~dp0\%fullstamp%\build_log.txt"
IF %ERRORLEVEL%==0 SET x86DebugBuildResult=0

FINDSTR /C:"FBuild: OK: All+Test-x86-DebugUnicode" "%~dp0\%fullstamp%\build_log.txt"
...
FINDSTR /C:"FBuild: OK: All+TestRun-x86-Debug" "%~dp0\%fullstamp%\testDebug_log.txt"
IF %ERRORLEVEL%==0 SET x86DebugTestResult=0

FINDSTR /C:"FBuild: OK: All+TestRun-x86-DebugUnicode"  "%~dp0\%fullstamp%\testDebugUnicode_log.txt"
